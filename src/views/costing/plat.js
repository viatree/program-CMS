...
const plat = () => {
  ...
  const [data, setData] = useState([
    { no: 1, nama: 'Plat Kuningan Micro', proses: 'Emboss', harga: 'Rp.9000'},
    { no: 2, nama: 'Plat Timah', proses: 'Hostamp', harga: 'Rp.909900' },
    { no: 3, nama: 'Plat Timah', proses: 'Emboss', harga: 'Rp.71900' },
  ]);
        ...
        <CTable hover striped bordered responsive>
          <CTableHead>
            <CTableRow>
              ...
              <CTableHeaderCell>Proses</CTableHeaderCell>
          ...
          <CTableBody>
            {filteredData.map((item, index) => (
              <CTableRow key={index}>
                ...
                <CTableDataCell>{item.proses}</CTableDataCell>
