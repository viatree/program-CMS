...
const kertas = () => {
  ...
  const [data, setData] = useState([
    { no: 1, nama: 'Primer', gramatur: '20', harga: 'Rp.9000'},
    { no: 2, nama: 'Lem 4 sisi', gramatur: '100', harga: 'Rp.909900' },
    { no: 3, nama: 'Primer', gramatur: '0.42', harga: 'Rp.71900' },
  ]);
        ...
        <CTable hover striped bordered responsive>
          <CTableHead>
            <CTableRow>
              ...
              <CTableHeaderCell>Gramatur</CTableHeaderCell>
          ...
          <CTableBody>
            {filteredData.map((item, index) => (
              <CTableRow key={index}>
                ...
                <CTableDataCell>{item.gramatur}</CTableDataCell>
