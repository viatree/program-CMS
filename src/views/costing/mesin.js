...
const mesin = () => {
  ...
  const [data, setData] = useState([
    { no: 1, nama: 'Sablon',satuan:'Rp.25400,00', harga: 'Rp.96000', min: '2000' },
    { no: 2, nama: 'Dazen',satuan:'Rp.640,00', harga: 'Rp.93000', min: '4000' },
    { no: 3, nama: 'SORS',satuan:'Rp.3600,00', harga: 'Rp.94000', min: '90000' },
  ]);
          ...
          <CTableBody>
            {filteredData.map((item, index) => (
              <CTableRow key={index}>
                ...
                <CTableDataCell>{item.satuan}</CTableDataCell>
