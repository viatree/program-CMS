...
const biayaFinishing = () => {
  ...
  const [data, setData] = useState([
    { no: 1, nama: 'lorem', min: '20', harga: 'Rp.30000',rumus:'P x L x 0.15 x QTY' },
    { no: 2, nama: 'lorem ipsum', min: '100', harga: 'Rp.100000',rumus:'P x L x 0.15 x QTY' },
    { no: 3, nama: 'ipsum', min: '0.42', harga: 'Rp.20000',rumus:'P x L x 0.15 x QTY' },
  ]);
        ...
        <CTable hover striped bordered responsive>
          <CTableHead>
            <CTableRow>
              ...
              <CTableHeaderCell>Rumus/Jenis Input</CTableHeaderCell>
          ...
          <CTableBody>
            {filteredData.map((item, index) => (
              <CTableRow key={index}>
                ...
                <CTableDataCell>{item.rumus}</CTableDataCell>
                <CTableDataCell>
